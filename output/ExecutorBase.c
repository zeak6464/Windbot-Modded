...
void WindBot_Game_AI_Executor_AddExecutor(WindBot_Game_AI_Executor* object, WindBot_Game_AI_ExecutorType type, int32_t cardId, int32_t v)
{
    const char __method_name[] = "WindBot.Game.AI.Executor:AddExecutor(WindBot.Game.AI.ExecutorType,int,int)";
    static MonoMethod *__method = 0;
